...
duet-table.duet-table-hide-head-visually.duet-table-hide-head-visually thead,
duet-table.duet-table-hide-head-visually.duet-table-hide-head-visually thead * {
...
.duet-table-striped.duet-table-sticky.duet-theme-turva thead th {
  border-bottom-color: rgb(228, 228, 230);
}
...
.duet-table-striped.duet-theme-turva tfoot td {
  border-top-color: rgb(228, 228, 230);
}
...
.duet-table-fixed th, .duet-table-minimal th, .duet-table-plain th {
  ...
  border-bottom: 1px solid rgb(101, 119, 135);
}
...
.duet-theme-turva.duet-table-fixed th, .duet-theme-turva.duet-table-minimal th, .duet-theme-turva.duet-table-plain th {
  border-bottom-color: rgb(68, 68, 69);
}
