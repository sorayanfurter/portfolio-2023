...
.duet-hero.duet-hero-product.duet-theme-turva .brand-shaped-image {
  top: -185px;
  right: 0;
  left: 0;
  width: 485px;
...
@media (min-width: 62em) {
  .duet-hero.duet-hero-product.duet-theme-turva .brand-shaped-image.narrow {
    right: 40%;
    left: auto;
  }
}
...
.duet-hero.duet-hero-product.duet-theme-turva .brand-shaped-image .brand-shaped-image-bg {
  width: 600px;
  height: 320px;
...
@media (min-width: 62em) {
  .duet-hero.duet-hero-product.duet-theme-turva .brand-shaped-image .brand-shaped-image-bg:not(.narrow) { /* stylelint-disable-line */
    width: 800px;
    height: 470px;
  }
}
.duet-hero.duet-hero-product.duet-theme-turva .brand-shaped-icon {
  top: 150px;
...
.duet-hero.duet-hero-product.duet-theme-turva .brand-shaped-icon duet-icon {
  position: relative;
  top: -10px;
  transform: rotate(0deg);
}
...
@media (min-width: 76.25em) {
  .duet-hero.duet-hero-product.duet-theme-turva .brand-shaped-icon.narrow {
    right: 40%;
  }
}
@media (min-width: 76.25em) {
  .duet-hero.duet-hero-product.duet-theme-turva .brand-shaped-icon:not(.narrow) {
    right: 340px;
  }
}
