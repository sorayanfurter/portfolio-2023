...
const DuetChoice = class {
  ...
  watchLanguageStateHandler(newValue, oldValue) {
    if (newValue !== oldValue && this.accessibleLabelInfoButton === this.accessibleLabelInfoButtonDefaults[oldValue]) {
      this.accessibleLabelInfoButton = languageUtils.getLocaleString(this.accessibleLabelInfoButtonDefaults, newValue);
    }
    if (newValue !== oldValue && this.infoLabel === this.infoLabelDefaults[oldValue]) {
      this.infoLabel = languageUtils.getLocaleString(this.infoLabelDefaults, newValue);
    }
  }
  /**
