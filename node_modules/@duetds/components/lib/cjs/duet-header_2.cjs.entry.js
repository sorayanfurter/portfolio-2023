...
const DefaultLogo = ({ inverse, logoId, language }) => {
  const logoColor = inverse ? tokens_module.colorGrayLightest : tokens_module.colorPrimary;
...
const DuetLogo = class {
  ...
  render() {
    ...
    return (index.h(index.Host, { class: { "duet-m-0": this.margin === "none" } }, index.h(TagName, { href: this.href, ref: link => (this.nativeLink = link), "aria-label": this.accessibleLabel, class: {
        "duet-logo": true,
        [this.size]: true,
        "duet-theme-turva": this.theme === "turva",
