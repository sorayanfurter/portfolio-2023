...
const DuetDatePicker = class {
  ...
  watchLanguageStateHandler(newValue, oldValue) {
    if (newValue !== oldValue && this.placeholder === this.placeholderDefaults[oldValue]) {
      this.placeholder = languageUtils.getLocaleString(this.placeholderDefaults, newValue);
    }
  }
  updateValidity() {
