...
const DuetHero = class {
  ...
  render() {
    ...
    return (index.h("div", { role: "region", class: {
      ...
      }, part: "duet-hero" }, campaignOrSection && this.image && (index.h("div", { class: "background-area" }, index.h("div", { class: "background-container" }, index.h("div", { class: "background" }, index.h("img", { src: this.image, alt: "", role: "presentation" })), index.h("div", { class: "brand-shape" })))), this.variation === "product" && this.image && (index.h("div", { class: { "background-area": true, [this.layout]: true } }, index.h("div", { class: { "background-container": true, [this.layout]: true } }, index.h("div", { class: { background: true, [this.layout]: true } }, index.h("div", { class: { "background-mask": true, [this.layout]: true } }), this.theme !== "turva" && index.h("div", { class: { "brand-shape": true, [this.layout]: true } }), index.h("div", { class: { "brand-shaped-image": true, [this.layout]: true } }, index.h("div", { class: { "brand-shaped-image-wrapper": true, [this.layout]: true } }, index.h("div", { class: { "brand-shaped-image-bg": true, [this.layout]: true }, style: styles }))), this.categoryIcon && (index.h("div", { class: { "brand-shaped-icon": true, [this.layout]: true } }, index.h("duet-icon", { class: { [this.layout]: true }, background: "none", name: this.categoryIcon, margin: "none", size: "auto", responsive: false }))))))), this.variation === "content" && this.image && (index.h("div", { class: "background-area" }, index.h("div", { class: "background" }, index.h("div", { class: "background-mask" }), this.theme !== "turva" && index.h("div", { class: "brand-shape" }), index.h("div", { class: "brand-shaped-image" }, index.h("div", { class: "brand-shaped-image-wrapper" }, index.h("div", { class: "brand-shaped-image-bg", style: styles })))))), index.h("div", { class: { "duet-hero-wrapper": true, [this.layout]: true } }, this.image && this.variation === "image" && (index.h("div", { class: "duet-hero-image-mask" }, index.h("div", { class: "duet-hero-image-wrapper" }, index.h("div", { class: "duet-hero-image", style: styles })))), (this.variation === "gray" || this.variation === "light" || this.variation === "minimal") &&
