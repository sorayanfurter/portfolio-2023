...
const DuetIcon = class {
  ...
  render() {
    ...
    const backgroundRotationStyles = this.backgroundRotation
      ...
      : {};
    const styles = Object.assign({ color, background: tokenUtils.rgbaColorFromRgb(tokenUtils.getColorByName(this.background, this.theme), this.backgroundOpacity), "border-color": tokenUtils.getColorByName(this.outline, this.theme) }, backgroundRotationStyles);
    ...
    return (index.h(index.Host, { class: {
      ...
      } }, index.h("span", { "aria-hidden": "true", class: { "duet-icon-svg": true, rotated: this.shape === "brand-rotated" && this.theme !== "turva" }, innerHTML: this.svgContent, style: iconStyles }))));
  }
