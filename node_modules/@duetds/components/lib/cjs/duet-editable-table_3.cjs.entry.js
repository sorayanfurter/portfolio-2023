...
const UploadItem = ({ data, showLinks, type, actions, errorCodes, theme, label, categoryLabel, showCategory, }) => {
  ...
  const getFileNameLine = () => {
    switch (type) {
      case "inprogress":
        return (index.h("span", { class: "duet-upload-item-name", role: "status" },
          ...
          index.h("duet-visually-hidden", null,
            index.h("duet-paragraph", null, languageUtils.getLocaleString(fileUploadingInfo))),
  ...
  return (index.h("div", { class: {
    ...
    index.h("div", { class: "item-actions" }, actions.map(actionItem => {
      return (index.h("duet-action-button", { actionMeta: Object.assign({}, meta || {}), actionId: uid || null, actionName: actionItem.name, theme: theme, iconName: actionItem.icon, iconColor: actionItem.color, iconSize: actionItem.size, background: actionItem.background, "accessible-label": `${actionDescription} ${languageUtils.getLocaleString(actionItem.label)} `, accessibleTitle: false }));
    }))));
};

const UploadItemHeader = ({ label, categoryLabel }) => {
  return (index.h("div", { class: "items-header" },
    categoryLabel && (index.h("duet-heading", { class: "category-header", border: "solid", color: "gray-darker", level: "h3", "visual-level": "h6", weight: "semibold", margin: "none" }, languageUtils.getLocaleString(categoryLabel))),
    index.h("duet-heading", { class: { "filename-header": true, "no-category": !categoryLabel }, border: "solid", color: "gray-darker", level: "h3", "visual-level": "h6", weight: "semibold", margin: "none" }, languageUtils.getLocaleString(label))));
};
