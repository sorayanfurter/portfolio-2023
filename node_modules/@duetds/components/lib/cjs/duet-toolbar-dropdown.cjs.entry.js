...
const DuetToolbarDropdown = class {
  ...
  render() {
    ...
    return (index.h(index.Host, null, index.h("div", { class: {
        ...
        [itemsAlign]: true,
      } }, index.h("button", { ref: element => (this.button = element), "aria-haspopup": "menu", "aria-controls": "menu", "aria-expanded": this.open ? "true" : "false", "aria-current": this.active ? "true" : "false", "aria-label": this.accessibleLabel, id: "button", type: "button", class: {
        active: this.active,
        open: this.open,
...
DuetToolbarDropdown.style = duetToolbarDropdownCss;

exports.duet_toolbar_dropdown = DuetToolbarDropdown;
