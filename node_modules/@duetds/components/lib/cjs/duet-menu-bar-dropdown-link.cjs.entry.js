...
const DuetMenuBarDropdownLink = class {
  ...
  render() {
    return (index.h(index.Host, null, index.h("a", { class: {
      ...
      }, href: this.href, role: "menuitem", onKeyUp: e => this.handleEscape(e), "aria-label": this.accessibleLabel }, this.icon && (index.h("duet-icon", { theme: this.theme, name: this.icon, size: "x-small", margin: "none", color: "currentColor" })), index.h("slot", null))));
  }
  get element() { return index.getElement(this); }
};
DuetMenuBarDropdownLink.style = duetMenuBarDropdownLinkCss;

exports.duet_menu_bar_dropdown_link = DuetMenuBarDropdownLink;
