...
const patchBrowser = () => {
    ...
    // TODO(STENCIL-663): Remove code related to deprecated `safari10` field.
    {
        ...
        if (!index.win.customElements) {
            ...
            // @ts-ignore
            return Promise.resolve().then(function () { return require(/* webpackChunkName: "polyfills-dom" */ './dom-c42e1019.js'); }).then(() => opts);
        }
    }
