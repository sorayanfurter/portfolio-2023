...
const DuetScrollable = class {
  ...
  render() {
    return (index.h(index.Host, { class: {
      ...
      } }, this.hasCollapseButtonLabelSlot && (index.h("div", { class: {
        collapse: true,
        hide: !this.isTabContentSmallerThanWrapper && !this.collapsed,
      } }, index.h("duet-button", { variation: "plain", margin: "none", "center-text": true, onClick: () => this.collapsedOnClick() }, index.h("slot", { name: "collapse-button-label" })))), index.h("div", { class: {
        "duet-scrollable-items": true,
        buttons: this.buttons,
        center: this.center,
      } }, index.h("button", { part: `${this.identifier}-button-left`, "aria-hidden": "true", class: {
      ...
      }, onClick: () => this.scrollLeft(), disabled: this.tablistAtStart, tabindex: "-1", hidden: !this.buttons }, index.h("duet-icon", { name: "action-arrow-left-small", size: "small", margin: "none" })), index.h("div", { class: {
        [this.tabListClass]: true,
        collapsed: this.collapsed,
      }, onScroll: () => this.updateScrollButtons(), ref: element => (this.tabListElement = element) }, index.h("slot", null)), index.h("button", { part: `${this.identifier}-button-right`, "aria-hidden": "true", class: {
        "duet-scrollable-button": true,
        "duet-scrollable-button--right": true,
        "duet-scrollable-button--occluded": !this.isTabContentSmallerThanWrapper,
      }, onClick: () => this.scrollRight(), disabled: this.tablistAtEnd, tabindex: "-1", hidden: !this.buttons }, index.h("duet-icon", { name: "action-arrow-right-small", size: "small", margin: "none" })))));
  }
...
const DuetTabGroup = class {
  ...
  render() {
    ...
    return (index.h("div", { class: {
      ...
      } }, this.renderTab()), index.h("div", { role: "tabpanel", tabindex: this.setTabIndex ? null : "0", class: {
