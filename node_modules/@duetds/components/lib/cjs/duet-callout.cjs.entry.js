...
const DuetCallout = class {
  ...
  render() {
    ...
    return (index.h(index.Host, null, index.h("div", { class: {
      ...
      } }, index.h("figure", { class: "container" }, index.h("duet-icon", { class: "callout-icon", shape: "brand-rotated", background: "primary-lighter", "background-opacity": "0.75", "background-rotation": this.theme === "turva" ? "0" : "7", color: "secondary", icon: icon, size: "auto", margin: "none", theme: this.theme }), index.h("blockquote", null, index.h("duet-paragraph", { variation: "intro", weight: "semi-bold", margin: "none", theme: this.theme }, index.h("slot", null))), this.hasAuthorSlot && (index.h("figcaption", { class: "author" }, index.h("span", null, "\u2014 "), index.h("span", null, index.h("slot", { name: "author" }))))))));
  }
  get element() { return index.getElement(this); }
};
DuetCallout.style = duetCalloutCss;

exports.duet_callout = DuetCallout;
