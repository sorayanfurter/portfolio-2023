...
const DuetMenuBar = class {
  constructor(hostRef) {
    ...
    this.mql = [
      ...
      window.matchMedia(tokens.media_query_xx_large.replace(/'/g, "")),
    ];
  ...
  render() {
    ...
    return (index.h(index.Host, null, index.h("nav", { class: {
        "duet-menu-bar": true,
        "duet-theme-turva": this.theme === "turva",
        "horizontal-nav": isUsedAsAdditionalHorizontalNav,
      }, "aria-label": this.accessibleLabel }, index.h("div", { class: "top" }), index.h("div", { class: { container: true }, ref: el => (this.container = el), onScroll: () => this.scrollbarCheck() }, this.logo && (index.h("div", null, index.h("duet-logo", { size: this.logoSize, margin: "none", theme: this.theme, href: this.logoHref, accessibleLabel: this.logoLinkAccessibleLabel, onClick: this.handleLogoClick }))), index.h("div", { class: "list center", role: "list" }, index.h("div", { class: "more-left", hidden: !this.leftMoreVisible, role: "presentation" }), index.h("slot", { name: "center" }), index.h("div", { class: "more-right", hidden: !this.rightMoreVisible, role: "presentation" })), index.h("div", { class: "list right", role: "list" }, index.h("slot", { name: "right" }))), index.h("div", { class: "bottom" }))));
  }
  get element() { return index.getElement(this); }
};
DuetMenuBar.style = duetMenuBarCss;

exports.duet_menu_bar = DuetMenuBar;
