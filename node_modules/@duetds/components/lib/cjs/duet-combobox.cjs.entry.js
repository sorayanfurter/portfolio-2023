...
const DuetCombobox = class {
  ...
  render() {
    ...
    return (index.h(index.Host, { role: "combobox", "aria-expanded": this.listOpen ? "true" : "false", "aria-owns": "duet-combobox-list-element", "aria-haspopup": "listbox", class: {
        "duet-combobox": true,
        [`duet-theme-${this.theme}`]: true,
      } }, index.h("slot", null), index.h("div", { role: "list", class: {
      ...
      }, role: "listbox", ref: el => (this.listElement = el), id: "duet-combobox-list-element" }, selectElements.map((item, index$1) => {
