...
const DuetTooltip = class {
  ...
  watchLanguageStateHandler(newValue, oldValue) {
    if (newValue !== oldValue && this.accessibleLabel === this.accessibleLabelDefault[oldValue]) {
      this.accessibleLabel = languageUtils.getLocaleString(this.accessibleLabelDefault, newValue);
    }
    if (newValue !== oldValue && this.accessibleCloseLabel === this.accessibleCloseLabelDefault[oldValue]) {
      this.accessibleCloseLabel = languageUtils.getLocaleString(this.accessibleCloseLabelDefault, newValue);
    }
  }
  /**
  ...
  render() {
    ...
    return (index.h(index.Host, { style: tooltipStyles }, index.h("button", { ref: element => (this.buttonEl = element), "aria-controls": this.tooltipId, "aria-expanded": this.active ? "true" : "false", onClick: this.toggleOpen, type: "button", class: {
      ...
      : this.accessibleLabel))), index.h("div", { ref: element => (this.tooltipEl = element), style: positionStyles, class: {
        "duet-tooltip": true,
        "duet-theme-turva": this.theme === "turva",
        "duet-tooltip-has-label": !!this.label,
        "duet-tooltip-active": this.active === true,
      }, onClick: e => e.stopPropagation(), onKeyDown: this.handleKeyDown, onFocusout: this.handleFocusOut }, index.h("div", { ref: element => (this.scrollableEl = element), class: "duet-tooltip-scrollable", tabindex: "0", id: this.tooltipId }, index.h("slot", null)), index.h("div", { ref: element => (this.arrowEl = element), class: { arrow: true, [this.placement]: true }, style: arrowStyles }, index.h("div", { class: { "arrow-container": true, [this.placement]: true } })), index.h("button", { type: "button", class: "duet-tooltip-close", onClick: this.handleCloseClick }, index.h("duet-icon", { name: "navigation-close-small", margin: "none", color: "currentColor", size: "xxx-small" }), index.h("duet-visually-hidden", null, this.accessibleCloseLabel)))));
  }
