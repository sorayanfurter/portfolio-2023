...
const DuetSlideoutPanelDropdown$1 = /*@__PURE__*/ proxyCustomElement(class extends H {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
...
function defineCustomElement$1() {
  ...
  const components = ["duet-slideout-panel-dropdown", "duet-icon"];
  components.forEach(tagName => { switch (tagName) {
    case "duet-slideout-panel-dropdown":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, DuetSlideoutPanelDropdown$1);
      }
      break;
    case "duet-icon":
      if (!customElements.get(tagName)) {
...
const DuetSlideoutPanelDropdown = DuetSlideoutPanelDropdown$1;
const defineCustomElement = defineCustomElement$1;

export { DuetSlideoutPanelDropdown, defineCustomElement };
