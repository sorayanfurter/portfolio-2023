...
function defineCustomElement$1() {
  ...
  const components = ["duet-page-heading", "duet-icon"];
  components.forEach(tagName => { switch (tagName) {
    case "duet-page-heading":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, DuetPageHeading$1);
      }
      break;
    case "duet-icon":
      if (!customElements.get(tagName)) {
...
const DuetPageHeading = DuetPageHeading$1;
const defineCustomElement = defineCustomElement$1;

export { DuetPageHeading, defineCustomElement };
