...
const DuetToolbar$1 = /*@__PURE__*/ proxyCustomElement(class extends H {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
...
function defineCustomElement$1() {
  ...
  const components = ["duet-toolbar"];
  components.forEach(tagName => { switch (tagName) {
    case "duet-toolbar":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, DuetToolbar$1);
      }
      break;
  } });
}

const DuetToolbar = DuetToolbar$1;
const defineCustomElement = defineCustomElement$1;

export { DuetToolbar, defineCustomElement };
