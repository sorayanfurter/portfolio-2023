...
import { g as getLanguage, b as getLocale, a as getLocaleString } from './p-076452be.js';
...
function defineCustomElement$1() {
  ...
  const components = ["duet-number-input", "duet-button", "duet-caption", "duet-icon", "duet-input", "duet-label", "duet-spinner", "duet-tooltip", "duet-visually-hidden"];
