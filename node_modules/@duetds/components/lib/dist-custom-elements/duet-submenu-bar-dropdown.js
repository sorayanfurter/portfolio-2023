...
const DuetSubmenuBarDropdown$1 = /*@__PURE__*/ proxyCustomElement(class extends H {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
...
function defineCustomElement$1() {
  ...
  const components = ["duet-submenu-bar-dropdown", "duet-icon"];
  components.forEach(tagName => { switch (tagName) {
    case "duet-submenu-bar-dropdown":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, DuetSubmenuBarDropdown$1);
      }
      break;
    case "duet-icon":
      if (!customElements.get(tagName)) {
...
const DuetSubmenuBarDropdown = DuetSubmenuBarDropdown$1;
const defineCustomElement = defineCustomElement$1;

export { DuetSubmenuBarDropdown, defineCustomElement };
