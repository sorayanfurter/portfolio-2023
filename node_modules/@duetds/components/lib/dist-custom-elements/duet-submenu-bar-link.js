...
const DuetSubmenuBarLink$1 = /*@__PURE__*/ proxyCustomElement(class extends H {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
...
function defineCustomElement$1() {
  ...
  const components = ["duet-submenu-bar-link", "duet-icon"];
  components.forEach(tagName => { switch (tagName) {
    case "duet-submenu-bar-link":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, DuetSubmenuBarLink$1);
      }
      break;
    case "duet-icon":
      if (!customElements.get(tagName)) {
...
const DuetSubmenuBarLink = DuetSubmenuBarLink$1;
const defineCustomElement = defineCustomElement$1;

export { DuetSubmenuBarLink, defineCustomElement };
